...
def depositar(saldo, valor, extrato):
    if valor > 0:
        ...
        print("\n@@@ Ops! A operação falhou. O valor informado é inválido. @@@")
...
def sacar(saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\n@@@ Ops! A operação falhou! Você não tem saldo suficiente. @@@")
    elif excedeu_limite:
        print("\n@@@ Ops! A operação falhou! O valor do saque é maior que o limite. @@@")
    elif excedeu_saques:
        print("\n@@@ Ops! A operação falhou! Número de saques excedido. @@@")
    elif valor > 0:
        saldo -= valor
